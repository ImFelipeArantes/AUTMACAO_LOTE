...
class extracaoTeia:
    ...
    def tratar_modelo_gaia(self,removed_sevs='N'):
        cols_modelo = ['Sequencial', 'Cliente', 'Tipo', 'Logradouro', 'Numero', 'Complemento',
            ...
            '%Disponibilidade Rede Desejável']
